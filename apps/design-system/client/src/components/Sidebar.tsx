...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/general/icon-button', label: 'IconButton' },
      { href: '/general/menu', label: 'Menu' },
      { href: '/general/numeric-spinner', label: 'NumericSpinner' },
      { href: '/general/progress-bar', label: 'ProgressBar' },
      { href: '/general/progress-stepper', label: 'ProgressStepper' },
      { href: '/general/rating', label: 'Rating' },
      { href: '/general/search-field', label: 'SearchField' },
      { href: '/general/segmented-control', label: 'SegmentedControl' },
      { href: '/general/slider', label: 'Slider' },
      { href: '/general/stepper', label: 'Stepper' },
      { href: '/general/tab', label: 'Tab' },
      { href: '/general/table-row', label: 'TableRow' },
